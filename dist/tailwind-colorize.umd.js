(function(global2, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global2 = typeof globalThis !== "undefined" ? globalThis : global2 || self, global2["tailwind-colorize"] = factory());
})(this, function() {
  "use strict";
  var createPlugin$2 = {};
  var createPlugin$1 = {};
  ...
  for (var name in colorNames) {
    if (hasOwnProperty$4.call(colorNames, name)) {
  ...
  function useTheme({ theme: config }) {
    function transformArgument(arg) {
      switch (arg.id) {
        case "ShortHexCode":
        case "LongHexCode":
          return Color$1(arg.code);
        case "LiteralValue":
          return arg.value;
        case "ThemeColor":
    ...
    function transform([subject, calls]) {
      return calls.reduce((carry, call) => {
        ...
        return Color$1(carry[call.name](...args));
    ...
    function themeColor(path, weight, defaultValue) {
      const themePath = ["colors", path, weight].filter((value) => !!value).join(".");
  ...
  const parser = function() {
    ...
    function peg$parse(input, options) {
      ...
      var peg$e3 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false);
      var peg$e4 = peg$literalExpectation("rgb(", false);
      var peg$e5 = peg$literalExpectation(",", false);
      var peg$e6 = peg$literalExpectation(")", false);
      var peg$e7 = peg$literalExpectation("#", false);
      var peg$e8 = peg$literalExpectation("(", false);
      var peg$f0 = function(decimal, digits) {
      ...
      var peg$f2 = function(name2, weight) {
      ...
      var peg$f4 = function(code) {
        return new function LongHexCode() {
          this.id = "LongHexCode";
          this.code = join(code);
        }();
      };
      var peg$f5 = function(code) {
        return new function ShortHexCode() {
          this.id = "ShortHexCode";
          this.code = join(code);
        }();
      };
      var peg$f6 = function(fn) {
        return fn;
      };
      var peg$f7 = function(name2, args) {
      ...
      function peg$parseColor() {
        var s0;
        s0 = peg$parseThemeColor();
        if (s0 === peg$FAILED) {
          s0 = peg$parseRgbFunction();
          if (s0 === peg$FAILED) {
            s0 = peg$parseLongHexCode();
            if (s0 === peg$FAILED) {
              s0 = peg$parseShortHexCode();
              if (s0 === peg$FAILED) {
                s0 = peg$parseNumber();
              }
            }
      ...
      function peg$parseThemeColor() {
        var s0, s1, s2;
        s0 = peg$currPos;
        s1 = peg$parseString();
        if (s1 !== peg$FAILED) {
          s2 = peg$parseColorWeight();
          if (s2 === peg$FAILED) {
            s2 = null;
          }
          s0 = peg$f2(s1, s2);
      ...
      function peg$parseShortHexCode() {
  ...
  function colorize(options = {
    ...
    return plugin(({ config, matchUtilities, theme }) => {
      const props = theme("colorize.props");
